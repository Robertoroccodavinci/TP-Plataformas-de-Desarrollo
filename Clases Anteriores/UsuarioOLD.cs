...
{
    class UsuarioOLD : IComparable<UsuarioOLD>
    {
        private int ID;
        private int DNI;
        ...
        private CarroOld MiCarro;
        private int rol; // 1-Administrador 2-Cliente 3-Empresa

        public UsuarioOLD(int ID, int DNI, string Nombre, string Apellido, string Mail, string Password, long CUIT_CUIL, int rol)
        {
            nDNI = DNI;
            nID = ID;
            nNombre = Nombre;
        ...
        public int CompareTo(UsuarioOLD otro)
        {
